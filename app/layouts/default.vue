      ...
      <div class="flex flex-col min-w-0">
         <header
            ...
            <div class="flex items-center gap-3.5">
                  <div class="text-base font-extrabold tracking-tight">{{ title }}</div>
                  <div class="text-xs text-gray-500">{{ subtitle }}</div>
            </div>
            <div class="flex items-center gap-3.5">
               <NuxtLink to="/" class="text-[13px] font-semibold text-gray-500 hover:text-primary transition-colors">Xem
                  website →</NuxtLink>
               <div class="w-px h-6.5 bg-gray-200"></div>
         ...
         <main class="flex-1 px-6 pt-6.5 pb-10">
            <slot />
         </main>
      </div>
   </div>
